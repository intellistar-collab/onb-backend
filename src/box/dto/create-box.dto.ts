...
export class CreateBoxDto {
  ...
  @ApiProperty({
    example: "0",
    required: false,
    description: "Total revenue generated by this box",
  })
  @IsOptional()
  @IsString()
  totalRevenue?: string;
  ...
  @ApiProperty({
    example: "0",
    required: false,
    description: "Total payout given by this box",
  })
  @IsOptional()
  @IsString()
  totalPayout?: string;
  ...
  @ApiProperty({
    example: "0",
    required: false,
    description: "Total exchangeable payout given by this box",
  })
  @IsOptional()
  @IsString()
  exchangeablePayout?: string;

  @ApiProperty({
    example: "0.20",
    required: false,
    description: "Percentage of exchangeable payout to retain as profit",
  })
  @IsOptional()
  @IsString()
  retainedProfitPercentage?: string;
}
